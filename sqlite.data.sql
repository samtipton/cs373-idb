...
INSERT INTO "idb_mvp" VALUES(1,'Malcolm','Smith','OLB','1989-07-05','Woodland Hills, CA','Woodland Hills (CA) Taft','Southern California',2011,1,465000,'MalcSmitty','446422781169651712','zfB8hCsHwLE',34.1683,-118.605);
INSERT INTO "idb_mvp" VALUES(2,'Joe','Flacco','QB','1985-01-16','Audubon, NJ','Audubon (NJ) Audubon','Delaware',2008,1,20100000,'JoeFlacco','446422363865755648','fod3tDCNZ80',39.8901,-75.0724);
INSERT INTO "idb_mvp" VALUES(3,'Eli','Manning','QB','1981-01-03','New Orleans, LA','New Orleans (LA) Newman','Mississippi',2004,1,13000000,'EliManning','446087270404075520','I7vZ1dVSe6I',29.9667,-90.05);
INSERT INTO "idb_mvp" VALUES(4,'Aaron','Rodgers','QB','1983-12-02','Chico, CA','Chico (CA) Pleasant Valley','California',2005,1,900000,'theaaronrodgers','451545403163287553','BHvCUulipS0',39.74,-121.8356);
INSERT INTO "idb_mvp" VALUES(5,'Drew','Brees','QB','1979-01-15','Austin, TX','Austin (TX) Westlake','Purdue',2001,1,9750000,'DB9NFL','451546253852037120','6iv8WVzbXEg',32.9825,-97.205);
INSERT INTO "idb_mvp" VALUES(6,'Santonio','Holmes','WR','1984-03-03','Belle Glade, FL','Belle Glade (FL) Glades Central','Ohio State',2006,1,7500000,'santonioholmes','451546782057500673','pNakPqb98Sk',26.6853,-80.6714);
INSERT INTO "idb_mvp" VALUES(7,'Peyton','Manning','QB','1976-03-24','New Orleans, LA','New Orleans (LA) Newman','Tennessee',1998,1,18000000,'pages/Peyton-Manning/109563725729117','451547106910535680','UzZi_GuWXmk',29.9667,90.05);
INSERT INTO "idb_mvp" VALUES(8,'Hines','Ward','WR','1976-03-08','Seoul, South Korea','Forest Park (GA) Forest Park','Georgia',1998,0,3000000,'officialhinesward','451547574294417409','6KPC5SbfMLw',37.5665,126.978);
INSERT INTO "idb_mvp" VALUES(9,'Deion','Branch','WR','1979-07-18','Albany, GA','Albany (GA) Monroe','Louisville',2002,1,925000,'pages/Deion-Branch/108196942541674','451547753600913408','3rCDogcKhPM',31.5822,-84.1656);
INSERT INTO "idb_mvp" VALUES(10,'Tom','Brady','QB','1977-08-03','San Mateo, CA','San Mateo (CA) Junipero Serra','Michigan',2000,1,2000000,'TomBrady','451547916428001280','X8toiXDuzn4',37.5542,-122.3131);
...
INSERT INTO "idb_franchise" VALUES(1,'Seahawks','Seattle','WA','Paul Allen','John Schneider','Pete Carroll',1974,1,'CenturyLink Field','NFC West','Seahawks','446422083765956608','l9-NicPH-58',47.5953,-122.3317);
INSERT INTO "idb_franchise" VALUES(2,'Ravens','Baltimore','MD','Steve Bisciotti','Ozzie Newsome','John Harbaugh',1996,1,'M&T Bank Stadium','AFC North','baltimoreravens','446421801954852864','xvkYrio5JYg',39.2781,-76.6228);
INSERT INTO "idb_franchise" VALUES(3,'Giants','New York','NJ','John Mara','Jerry Reese','Tom Coughlin',1925,1,'MetLife Stadium','NFC East','newyorkgiants','446421524447117312','HAhCCm-_0Ig',40.8136,-74.0744);
INSERT INTO "idb_franchise" VALUES(4,'Packers','Green Bay','WI','Green Bay Packers, Inc.','Ted Thompson','Mike McCarthy',1919,1,'Lambeau Field','NFC North','Packers','451544186739634176','pr9dq6Wa8ao',44.5014,-88.0622);
INSERT INTO "idb_franchise" VALUES(5,'Saints','New Orleans','LA','Tom Benson','Mickey Loomis','Sean Payton',1967,1,'Mercedes-Benz Superdome','NFC South','neworleanssaints','451544324249882624','z23NV3pvrvw',29.9508,-90.0811);
INSERT INTO "idb_franchise" VALUES(6,'Steelers','Pittsburgh','PA','Dan Rooney','Kevin Colbert','Mike Tomlin',1933,1,'Heinz Field','NFC North','steelers','451544466084478976','4R9PUh2JoHE',40.4467,-80.0158);
INSERT INTO "idb_franchise" VALUES(7,'Colts','Indianapolis','IN','Jim Irsay','Ryan Grigson','Chuck Pagano',1953,1,'Lucas Oil Stadium','AFC South','colts','451544637786697728','0MLKaIexSeM',39.7601,-86.1638);
INSERT INTO "idb_franchise" VALUES(8,'Patriots','New England','MA','Robert Kraft','Bill Belichick','Bill Belichick',1959,1,'Gillette Stadium','AFC East','newenglandpatriots','451544728324939777','o8Bpa59pGnA',42.0909,-71.2643);
INSERT INTO "idb_franchise" VALUES(9,'Eagles','Philadelphia','PA','Jeffrey Lurie','Howie Roseman','Chip Kelly',1933,1,'Lincoln Financial Field','NFC East','philadelphiaeagles','451544818934493184','3uaF5FYGiis',39.9008,-75.1675);
INSERT INTO "idb_franchise" VALUES(10,'Bears','Chicago','IL','Virginia Halas McCaskey','Phil Emery','Marc Trestman',1919,1,'Soldier Field','NFC North','ChicagoBears','451544950295912448','yp6PSPu8qVg',41.8625,-87.6167);
INSERT INTO "idb_franchise" VALUES(11,'Cardinals','Arizona','AZ','Bill Bidwill','Steve Keim','Bruce Arians',1898,1,'University of Phoenix Stadium','NFC West','arizonacardinals','451545069774848000','WErrzXz6D7I',33.5275,-112.2625);
INSERT INTO "idb_franchise" VALUES(12,'49ers','San Francisco','CA','Jed York','Trent Baalke','Jim Harbaugh',1946,1,'Levi''s Stadium','NFC West','SANFRANCISCO49ERS','451545166600355840','587Oow7Ckko',37.4034,-121.9703);
INSERT INTO "idb_franchise" VALUES(13,'Broncos','Denver','CO','Pat Bowlen','John Elway','John Fox',1960,1,'Sports Authority Field','AFC West','DenverBroncos','451545258929577984','HGMbmbnu2Oc',39.7439,-105.02);
INSERT INTO "idb_franchise" VALUES(14,'Panthers','Carolina','NC','Jerry Richardson','Dave Gettleman','Ron Rivera',1993,1,'Bank of America Stadium','NFC South','CarolinaPanthers','451545705941708801','cJlTyJletUw',35.2258,-80.8528);
